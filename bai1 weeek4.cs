...
namespace exerciseW4_bai1
{
    public class Employee
    {
        private string name, id;
        private double bthYear, bsSal, sal;
        ...
        public virtual void Input()
        {
            ...
            this.bthYear = int.Parse(Console.ReadLine());
            Console.Write("Basic Salary: ");
            this.bsSal = int.Parse(Console.ReadLine());
        }
    ...
    public class Company
    {
        ...
        {
            Console.WriteLine("\nTotal Salary of All Employees in the Company is " + this.totalSalary);
        }
    }
